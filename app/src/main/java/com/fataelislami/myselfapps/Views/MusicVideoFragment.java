...
public class MusicVideoFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View viewFragment=inflater.inflate(R.layout.fragment_music_video,container,false);
        ViewPager viewPager=(ViewPager) viewFragment.findViewById(R.id.pagerMusicVideo);
        MusicVideoPagerAdapter myPagerAdapter=new MusicVideoPagerAdapter(getFragmentManager());
